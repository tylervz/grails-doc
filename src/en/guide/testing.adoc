...
Grails writes HTML test reports to the `build/reports/test` directory and JUnit XML test reports to the `build/test-results` directory. The HTML reports are generally the best ones to look at.
